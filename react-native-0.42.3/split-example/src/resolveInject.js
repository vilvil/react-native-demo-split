...
function getFolderInBundle(resolver) {
    ...
    if (Platform.OS === 'android') {
        ...
        // console.log('bundlePath===>:'+resolver.bundlePath);
        // console.log('asset===>>'+JSON.stringify(resolver.asset));
        // console.log('joinPath==>:'+joinPath(bundleRoot, getScaledAssetPath(resolver.asset)));
        return resolver.fromSource(joinPath(bundleRoot, getScaledAssetPath(resolver.asset)));
    }
}
...
function getScaledAssetPath(asset): string {
    ...
    return asset.bundle + '/' + assetDir + '/' + asset.name + scaleSuffix + '.' + asset.type;
}
